...
bool GetIso14443bCommandFromReader(uint8_t* received, uint16_t* len);
void TransmitFor14443b_AsTag(const uint8_t* response, uint16_t len);
void CodeIso14443bAsReader(const uint8_t* cmd, int len, bool framing);
void CodeIso14443bAsTag(const uint8_t* cmd, int len);
