...
class CalypsoCard(Cardlet):
    ...
    def select_application(self, aid):
        if aid in self.applications:
            ...
            self.selected_record_index = 0  # Reinitialiser l'index des records lors de la s�lection
            self.status_word = RAPDU.SW.OK
        else:
...
# Point d'entr�e pour gerer les transactions Calypso
@staticmethod
...
def test_process_tpdu():
    ...
    # Test de la commande READ RECORD avec aucune application s�lectionn�e
